...
class Ui_ControlForm(object):
    def setupUi(self, ControlForm):
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.pos_x)
        self.pos_y = QtWidgets.QSpinBox(self.tabWidgetPage1)
        self.pos_y.setObjectName("pos_y")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.pos_y)
