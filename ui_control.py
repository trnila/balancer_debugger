...
class Ui_ControlForm(object):
    def setupUi(self, ControlForm):
        ...
        self.enableServos.setChecked(True)
        ...
        self.refreshBtn = QtWidgets.QPushButton(self.tabWidgetPage1)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.const_p)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.const_i)
        ...
        self.pos_x = QtWidgets.QSpinBox(self.tabWidgetPage1)
        self.pos_x.setObjectName("pos_x")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.pos_x)
        self.label_6 = QtWidgets.QLabel(self.tabWidgetPage1)
        self.label_6.setObjectName("label_6")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_6)
        self.pos_y = QtWidgets.QSpinBox(self.tabWidgetPage1)
        self.pos_y.setObjectName("pos_y")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.pos_y)
    ...
    def retranslateUi(self, ControlForm):
        ...
        self.pushButton.setText(_translate("ControlForm", "Reset"))
        self.refreshBtn.setText(_translate("ControlForm", "Refresh"))
        ...
        self.label_5.setText(_translate("ControlForm", "target posx"))
        self.label_6.setText(_translate("ControlForm", "target posy"))
